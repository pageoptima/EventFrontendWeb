  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="space-y-1.5">
        <label htmlFor="teaser-caption" className="text-sm font-medium text-foreground">
          Caption
        </label>
        <textarea
          id="teaser-caption"
      ...
      {processingTimedOut && (
        <div className="flex items-start gap-2 rounded-lg bg-destructive/10 px-3 py-2.5">
          ...
          <p className="text-xs text-destructive">
            ...
            remove your file, try again, or come back later.
          </p>
        </div>
      )}
...
export default TeaserDetailsForm;
