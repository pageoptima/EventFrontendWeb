...
import { useTeaserLikes } from "@/features/teaser/hooks/useTeaser";
import UserAvatar from "@/shared/components/common/UserAvatar";

function TeaserLikesModal({ teaserId, likeCount, onClose }) {
  const navigate = useNavigate();
  const bottomRef = useRef(null);

  const { data, isLoading, hasNextPage, fetchNextPage, isFetchingNextPage } =
    useTeaserLikes(teaserId, { enabled: true });
...
export default TeaserLikesModal;
